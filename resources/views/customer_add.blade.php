                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="m-b-30">
                                            <a href="customer/add" class="btn btn-primary waves-effect waves-light">Add Customer <i class="fa fa-plus"></i></a>
                                ...
                                <form class="form-horizontal" role="form" method="POST" 
                                    action="{{ URL('addcustomerprocess/'.$id) }}" accept-charset="UTF-8">
                                    {{ csrf_field() }}
